translations = {
    'en': {
        ...
        'allow_open_directory': 'Allow opening image directory',
        'allow_install_page': 'Allow access to install page',
        ...
        'prompts_copied': 'Prompts copied to clipboard',
        'translate': 'Translate',
    ...
    'zh': {
        ...
        'Delete': '删除',
        'Configuration save failed, please try again': '配置保存失败请重试',
        'delete': '删除',
        ...
        'allow_open_directory': '允许打开图片目录',
        'allow_install_page': '允许访问安装页面',
